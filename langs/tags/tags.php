...
<head>
    <title><?php echo "tags - ".$_GET['tags'];if($_GET['tags'] == 'search'){echo "tags";} ?></title>
    <meta charset="UTF-8">
...
$s_id = $_SESSION['id'];
if(isset($_GET['tags'])){
$q = "@".htmlentities($_GET['u'], ENT_QUOTES);
...
<td style='width: 100%;'>
<p><?php echo lang('nothingToShow'); ?><br><span style='font-size: small;color:gray;'><?php echo lang('tags_not_available'); ?></span></p>
</td>
</tr>
...
echo "
    <a href='../tags/".lang('news')."' class='selected_ht' title='#".lang('news')."'>#".lang('news')."</a>&nbsp;
    <a href='../tags/".lang('tv')."' class='selected_ht' title='#".lang('tv')."'>#".lang('tv')."</a> &nbsp;
    <a href='../tags/$s_country' class='selected_ht' title='$s_country'>#$s_country</a> &nbsp;
