...
<head>
    <title><?php echo $row_username; ?> | kartu pelajar</title>
    <meta charset="UTF-8">
        ...
        <div class="profile_picture_img profile_ppicture" style="<?php echo $profile_pic_border_var;?>">
            ...
            if($_SESSION['Username'] == $row_username){
                ...
                <label style='margin:0;'>
                    ...
                    <input style=\"display: none;\" type=\"file\" accept=\"image/png, image/jpeg, image/gif, image/jpeg\" name=\"photo_field\" onchange='profilePhoto(this);' />
                </label>
        ...
        <div class="profile_picture">
            ...
            <?php
               if($row_id != $_SESSION['id']){
                ...
                <?php
                if($row_id == $_SESSION['id']){
                    if (!empty($row_username)){echo "<span><img src='https://api.qrserver.com/v1/create-qr-code/?size=150x150&data=$row_username' border=3 height=140px width=140px><br></img><br><span class=\"fa fa-heartbeat\"></span> <br>".lang('qr_show_note')."<br></a></span><br></span>";};
                      echo "<span style='cursor:pointer;width:100%;display:inline-flex;'><a href='../settings?tc=edit_profile' class=\"silver_flat_btn\" style='width:100%;'><span class=\"fa fa-cog\"></span> ".lang('edit_profile0')."</a></span>";
            ...
            ?>
          </p><hr style="margin: 0;margin-bottom: 14px;">
            ...
            <table>
            <?php
            if (!empty($row_alpha)){echo "<span>Badge :<img src='$row_alpha' border=3 height=34px width=34px data-toggle='tooltip' title='Genezisitator'></img></span>";}
            if (!empty($row_qr)){echo "<span><img src='../imgs/badge/smafourmute.png' border=3 height=34px width=34px data-toggle='tooltip' title='SMAN 4 Muara Teweh Companion'></img></span>";}
            if (!empty($row_bio)){echo "<tr><td class='user_info_tdi'></td><p> $row_bio</h3></p>";}
            ...
            if (!empty($row_gender)){echo "<tr><td class='user_info_tdi'><i class=\"fa fa-strikethrough\"></i></td><td>".lang('gender_note')." $row_gender<td></tr>";}
            if (!empty($row_darah)){echo "<tr><td class='user_info_tdi'><i class=\"fa fa-medkit\"></i></td><td>".lang('darah_note')." $row_darah<td></tr>";}
            if (!empty($row_agama)){echo "<tr><td class='user_info_tdi'><i class=\"fa fa-strikethrough\"></i></td><td>".lang('a_note')." $row_agama<td></tr>";}
